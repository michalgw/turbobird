...
var
  fmViewDbTrigger: TfmViewDbTrigger;
...
procedure TfmViewDbTrigger.FormCreate(Sender: TObject);
var
   configFile: TIniFile;
...
procedure TfmViewDbTrigger.bbCloseClick(Sender: TObject);
begin
  Close;
  Parent.Free;
end;

procedure TfmViewDbTrigger.FormClose(Sender: TObject;
  var CloseAction: TCloseAction);
begin
  CloseAction := caFree;
end;

procedure TfmViewDbTrigger.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
